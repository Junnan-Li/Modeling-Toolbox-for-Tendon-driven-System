...
% integration of Muscles, Viapoints, and Obstacles and computing moment arm
% 
...
% moment arm of the second joint using diff. method
...
if abs(ma_numeric(2) - ma_) > 1e-6
    fprintf('Test Hand Moment arm case 1: failed! \n')
else
    fprintf('Test Hand Moment arm case 1: pass! \n')
end
...
% if abs(ma_numeric(2) - ma_) > 1e-6
%     fprintf('Test Hand Moment arm case 2: failed! \n')
% else
%     fprintf('Test Hand Moment arm case 2: pass! \n')
% end

%% hand 
% test obstacle and via points in hand objects
hand = create_hand_random('hand_Obstacle_Set', [1,2,0,0] );
