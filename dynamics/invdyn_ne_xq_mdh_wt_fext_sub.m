...
[FTau_wt_fext,~] = invdyn_ne_xq_mdh_all_fext(xq,xqD,xqDD,...
            mdh_ne,Mass,zeros(6,n_q+2), CoM_ne, I_ne, g);

%% gravity term
% xqD = 0; xqDD = 0; F_ext = 0;
[FTau_G,~] = invdyn_ne_xq_mdh_all_fext(xq,zeros(n_state,1),zeros(n_state,1),mdh_ne,Mass,zeros(6,n_q+2), CoM_ne, I_ne, g);

%% Coriolis term
% xqD = 0; xqDD = 0; F_ext = 0;
FTau_CG = invdyn_ne_xq_mdh_all_fext(xq,xqD,zeros(n_state,1),mdh_ne,Mass,zeros(6,n_q+2), CoM_ne, I_ne, g);
...
for i = 1:n_state
    ...
    xqDD_i(i) = 1;
    [FTau_MG,~] = invdyn_ne_xq_mdh_all_fext(xq,zeros(n_state,1),xqDD_i,mdh_ne,Mass,zeros(6,n_q+2), CoM_ne, I_ne, g);
