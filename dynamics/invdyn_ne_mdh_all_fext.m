...
function [Tau,F,W_T_allframe] = invdyn_ne_mdh_all_fext(q,qD,qDD,mdh, Mass, X_base,XD_base,XDD_base, F_ext, CoM, I, g)
%#codegen
...
for i = n_q+1:-1:1
    ...
    F(1:3,i) = F(1:3,i+1) - m_i*g + m_i*VD_c(1:3,i) - F_ext(1:3,i);
    F(4:6,i) = F(4:6,i+1) - cross(-W_i_r_c,F(1:3,i) + F_ext(1:3,i)) - cross(W_c_r_ip1,-F(1:3,i+1)) ...
