...
% Input:
%     w_T_link_frames:  [4,4,nq] transformation matrix for all links frames
...
function M = invdyn_lag_T_M_sym(w_T_link_frames, Mass, CoM, I) % , X_base, XD_base,XDD_base 
%#codegen
...
% for i = 1:n_q
%     base_T_all(:,4*i-3:4*i) = T_mdh_multi(mdh_q(1:i,:)); % transformation to each link frame
% end
